 ...
 */
@MessageSources(sources = { @MessageSource(bundleBaseName = "org.dejava.component.util.exception.properties.errors", processors = { ConstantValuesEntryProcessor.class }) })
