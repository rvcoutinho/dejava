 ...
 */
@MessageSources(sources = { @MessageSource(bundleBaseName = "org.dejava.component.exception.test.properties.error", processors = { "org.dejava.component.i18n.source.processor.impl.ConstantValuesEntryProcessor" }) })
