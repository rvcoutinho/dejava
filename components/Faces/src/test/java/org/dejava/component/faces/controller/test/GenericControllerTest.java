package org.dejava.component.faces.controller.test;

import javax.inject.Inject;

import org.dejava.component.ejb.component.GenericComponent;
import org.dejava.component.faces.controller.test.component.AbstractGenericComponentTest;
import org.dejava.component.faces.controller.test.util.Faces;
import org.dejava.component.faces.controller.test.util.FakeEntity;
import org.dejava.component.faces.controller.test.util.FakeEntityController;
...
public class GenericControllerTest extends AbstractGenericComponentTest {
		...
		return ShrinkWrap
				...
				.addAsLibraries(
						dependencyResolver.artifacts("org.dejava.component:ejb",
								...
								.resolveAsFiles()).addPackages(true, "org.dejava.component.faces.controller")
	...
	/**
	 * @see org.dejava.component.faces.controller.test.component.AbstractGenericComponentTest#getComponent()
	 */
	@Override
