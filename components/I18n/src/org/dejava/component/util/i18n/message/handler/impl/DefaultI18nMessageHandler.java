...
public class DefaultI18nMessageHandler implements MessageHandler {
	...
	/**
	 * Gets the locale to find the messages.
	 * 
	 * @return The locale to find the messages.
	 */
	...
	/**
	 * @see org.dejava.component.util.i18n.message.handler.MessageHandler#getMessage(java.lang.String,
