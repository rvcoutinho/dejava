 ...
 */
@MessageSources(sources = { @MessageSource(availableLocales = { "en_US", "pt_BR" }, sourcePath = "sample", bundleBaseName = "org.dejava.component.i18n.test.test.message.properties.error", processors = { "org.dejava.component.i18n.test.source.processor.impl.ConstantValuesEntryProcessor" }) })
