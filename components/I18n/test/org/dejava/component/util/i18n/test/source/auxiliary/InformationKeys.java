 ...
 */
@MessageSources(sources = { @MessageSource(sourcePath = "test", bundleBaseName = "org.dejava.component.util.i18n.test.source.properties.information", processors = { "org.dejava.component.util.i18n.test.source.auxiliary.SampleEntryProvider" }) })
