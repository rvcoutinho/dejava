 ...
 */
@MessageSources(sources = { @MessageSource(bundleBaseName = "org.dejava.component.reflection.properties.errors", processors = { "org.dejava.component.i18n.source.processor.impl.ConstantValuesEntryProcessor" }) })
