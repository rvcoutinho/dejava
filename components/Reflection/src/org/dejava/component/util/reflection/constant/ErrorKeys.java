 ...
 */
@MessageSources(sources = { @MessageSource(bundleBaseName = "org.dejava.component.util.reflection.properties.errors", processors = { ConstantValuesEntryProcessor.class }) })
