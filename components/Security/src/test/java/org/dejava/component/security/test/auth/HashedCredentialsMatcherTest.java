package org.dejava.component.security.test.auth;
...
import org.dejava.component.security.auth.credential.matcher.HashedCredentialsMatcher;
...
public class HashedCredentialsMatcherTest {
	 ...
	 * 
	 * @param rawCredentials
	 *            The raw credential to be matched.
	 */
	@ParametricTest(dataProvider = StaticMethodTestDataProvider.class, paramsValues = { "getSomeRawCredentials" })
	public void testMatcherSuccess(final String rawCredentials) {
	 ...
	 *            An uneven credentials pair (raw/hashed).
	 */
	@ParametricTest(dataProvider = StaticMethodTestDataProvider.class, paramsValues = { "getSomeUnevenCredentialsPairs" })
	public void testUnevenMatch(final Object[] credentialsPair) {
