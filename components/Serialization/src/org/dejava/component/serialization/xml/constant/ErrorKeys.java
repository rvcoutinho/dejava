 ...
 */
@MessageSources(sources = { @MessageSource(bundleBaseName = "org.dejava.component.serialization.xml.properties.errors", processors = { "org.dejava.component.i18n.test.source.processor.impl.ConstantValuesEntryProcessor" }) })
