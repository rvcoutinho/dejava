...
public final class XMLDecoder {
     ...
     */
    private static Class<? extends Object> getNodeClass(final Node node,
            final Class<?> probableClass) {
        // Tries to get the node class.
        try {
            // Gets the value of attribute "id" from the given node.
            final String nodeClassName = node.getAttributes().getNamedItem(CLASS_ATTR).
                    getTextContent();
     ...
     *             If the node is null.
     */
    private static void addNodeObjectToCollection(final Collection<Object> collection,
            final Node node,
    ...
    private static Object getNodeJNDIObjectValue(final Node node) throws XMLConversionException {
        ...
        try {
            ...
            final String jndiObjectName = node.getAttributes().getNamedItem(JNDI_OBJ_ATTR).
                    getTextContent();
            ...
            if ((node.getAttributes() != null) && (node.getAttributes().getNamedItem(
                    JNDI_OBJ_METHOD_ATTR) != null)) {
                ...
                for (Integer currentParamIndex = 1 ;; currentParamIndex++) {
                    ...
                    try {
                        ...
                        String currentJNDIParameterClass =
                                node.getAttributes().getNamedItem(JNDI_OBJ_METHOD_PARAM_CLASS_ATTR +
                                currentParamIndex).getTextContent();
                ...
                for (Integer currentParamIndex = 1 ; currentParamIndex <= jndiParamsClasses.size() ;
                        currentParamIndex++) {
                    ...
                    if ((node.getAttributes() != null) && (node.getAttributes().getNamedItem(
                        ...
                        Object currentParamValue =
                                node.getAttributes().getNamedItem(JNDI_OBJ_METHOD_PARAM_VALUE_ATTR +
                                currentParamIndex).getTextContent();
    ...
    private static Object createTextNodeObject(final Node node, final Class<?> probableClass,
        ...
        try {
            ...
            if ((node.getAttributes() == null) ||
                    (node.getAttributes().getNamedItem(JNDI_OBJ_ATTR) == null)) {
                ...
                // If not.
                    ...
                    object = ConstructorHandler.invokeConstructor(nodeClass, new Object[]{
                                nodeTextValue});
                }
                // Gets the node id.
        ...
        try {
            ...
            if ((node.getAttributes() == null) ||
                ...
                if (object == null) {
                    ...
                    return ConstructorHandler.invokeConstructor(getNodeClass(node, probableClass),
                            null);
                }
                // If it is not null.
                else {
    ...
    private static Object createComplexNodeObject(final Node node, Object object,
        ...
        try {
            ...
            for (Integer currentFieldNodeIndex = 0 ; currentFieldNodeIndex < fieldNodes.getLength() ;
                    currentFieldNodeIndex++) {
                ...
                if (currentFieldNode.getNodeType() != Node.TEXT_NODE) {
                    ...
                    if (isCollection(node, probableClass)) {
                        ...
                        addNodeObjectToCollection((Collection<Object>) object, currentFieldNode,
                                null, null,
    ...
    public static Object fromXML(final Node node, Object object, final Class<?> probableClass,
        ...
        try {
            ...
            // If it is not in the map.
                ...
                // a text node.
                if ((childNodes.getLength() == 0) || ((childNodes.getLength() == 1) && (childNodes.
                ...
                // Otherwise.
                    ...
                    object = createComplexNodeObject(node, object, probableClass,
                            objectsUnderConversion);
                }
                // Returns the object.
                return object;
     ...
     *             If the node is null.
     */
    public static Collection<? extends Object> fromXML(final NodeList nodes,
            final Class<?> probableClass,
        ...
        for (Integer currentNodeIndex = 0 ; currentNodeIndex < nodes.getLength() ;
                currentNodeIndex++) {
    ...
    public static Object fromXML(final Document xmlDocument, final Object object,
        ...
        if (xmlDocument.getChildNodes().getLength() == 1) {
            // Return one object.
            return fromXML(xmlDocument.getFirstChild(), object, probableClass,
                    objectsUnderConversion);
        }
