...
public class UserServiceTest {
	...
	public void assertNoUsersPersisted() {
		// Gets all users.
		final Collection<User> allUsers = userService.getAll(null, null);
		// Assert that there are no users persisted.
	...
	public void removeTestUsers() {
		// Gets all users.
		final Collection<User> allEntities = userService.getAll(null, null);
		// Removes all persisted users.
		userService.remove(allEntities);
	}
	...
	public void testGetByFacebookUserIdSuccess() throws InvocationException {
		...
		final User retrievedUser = userService.getByFacebookUser(fbUser);
