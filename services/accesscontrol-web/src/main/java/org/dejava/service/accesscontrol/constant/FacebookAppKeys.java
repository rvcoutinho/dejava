...
public class FacebookAppKeys {
	...
	/**
	 * Facebook app login redirect URL key (when login is made).
	 */
	public static final String APP_LOGIN_REDIRECT_URL = "facebook.app.redirect.url.login";

	/**
	 * Facebook app welcome redirect URL key (the last URL - when user is already logged in).
	 */
	public static final String APP_WELCOME_REDIRECT_URL = "facebook.app.redirect.url.welcome";
