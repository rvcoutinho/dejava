...
import org.dejava.service.message.businessrule.AppMessageBusinessRuleSet;
...
public class AppMessageComponent extends AbstractGenericComponent<AppMessage, Integer> {
	...
	@Inject
	@MessageCtx
	private AppMessageBusinessRuleSet appMessageBusinessRuleSet;

	/**
	 * @see org.dejava.component.ejb.component.AbstractGenericComponent#getEntityBusinessRuleSet()
	 */
	@Override
	public GenericEntityBusinessRuleSet<AppMessage> getEntityBusinessRuleSet() {
		return appMessageBusinessRuleSet;
	}
	 ...
	 *            Message to be sent.
	 */
	public void sendMessage(final AppMessage message) {
