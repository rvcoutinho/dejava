...
@NamedQueries(value = {
		@NamedQuery(name = "getProjectsByTag", query = "SELECT DISTINCT project FROM Project project JOIN project.tags tag WHERE tag = :tag"),
...
public class Project extends AbstractIdentifiedEntity {
	...
	public String getAllTags() {
		...
		if (getTags() != null) {
			// TODO
			Integer currentTagIdx = 0;
			// For each tag.
			for (final String currentTag : getTags()) {
	...
	/**
	 * The number of possible impacts for the project.
	 */
	private Long possibleImpacts = Long.valueOf(0);

	/**
	 * Gets the number of possible impacts for the project.
	 * 
	 * @return The number of possible impacts for the project.
	 */
	@Column(name = "possibleImpacts")
	public Long getPossibleImpacts() {
		return possibleImpacts;
	}

	/**
	 * Sets the number of possible impacts for the project.
	 * 
	 * @param possibleImpacts
	 *            New number of possible impacts for the project.
	 */
	public void setPossibleImpacts(final Long possibleImpacts) {
		this.possibleImpacts = possibleImpacts;
	}
	 ...
	 */
	public Project(final Integer identifier) {
		super();
	...
	private void countSharesByProject() throws NamingException {
		...
		final ProjectComponent projectComponent = InitialContext
				.doLookup("java:app/philanthropy-ejb/Component/Philanthropy/Project");
