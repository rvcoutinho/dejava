 ...
 */
@MessageSources(sources = { @MessageSource(availableLocales = { "" }, description = "Google Place API properties", bundleBaseName = "org.dejava.service.soupsocial.properties.google-places-api", processors = "org.dejava.component.i18n.source.processor.impl.ConstantValuesEntryProcessor") })
