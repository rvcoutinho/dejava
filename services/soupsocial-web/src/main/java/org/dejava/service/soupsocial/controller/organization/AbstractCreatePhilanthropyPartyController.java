 ...
 */
public abstract class AbstractCreatePhilanthropyPartyController implements Serializable {
	 ...
	 */
	public abstract PhilanthropyParty getParty();
	...
	public void updateAddressDetails() throws IOException {
		...
		getParty().getAddresses().add(placeComponent.getByGoogleReference(getAddressReference()));
	}
